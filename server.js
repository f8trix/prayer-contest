...
function initializeDataFiles() {
    if (!fs.existsSync(USERS_FILE)) {
        const initialUsers = {
            ...
            group2: [
                { id: 32, name: "أحمد جواد الجاسم", points: 0 },
                { id: 33, name: "آلاء يوسف السعيد", points: 0 },
                { id: 34, name: "أميرة علي الحسن", points: 0 },
                { id: 35, name: "البتول جواد الجاسم", points: 0 },
                { id: 36, name: "حبيب علي الحسن", points: 0 },
                { id: 37, name: "الحوراء جواد الجاسم", points: 0 },
                { id: 38, name: "رائدة علي الحسن", points: 0 },
                { id: 39, name: "الرباب حبيب الحسن", points: 0 },
                { id: 40, name: "رضا يوسف السعيد", points: 0 },
                { id: 41, name: "رقية حبيب الحسن", points: 0 },
                { id: 42, name: "الزهراء جواد الجاسم", points: 0 },
                { id: 43, name: "زينب حبيب الحسن", points: 0 },
                { id: 44, name: "زينب حسين الحسن", points: 0 },
                { id: 45, name: "سعاد خميس الجاسم", points: 0 },
                { id: 46, name: "علي صادق الحسن", points: 0 },
                { id: 47, name: "علي عبدالجبار الحسن", points: 0 },
                { id: 48, name: "علياء علي الحسن", points: 0 },
                { id: 49, name: "غلا عبدالجبار الحسن", points: 0 },
                { id: 50, name: "فاطمة جواد الجاسم", points: 0 },
                { id: 51, name: "فاطمة حبيب الحسن", points: 0 },
...
app.listen(PORT, () => {
    ...
    console.log('\n✨ المجموعات:');
    console.log('   المجموعة 1: 31 مستخدم');
    console.log('   المجموعة 2: 30 مستخدم'); 
    console.log('   المجموعة 3: 16 مستخدم');
    console.log('   الإجمالي: 77 مستخدم');
});